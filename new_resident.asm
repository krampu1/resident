...
NEXT_LINE_OFFSET    equ 71 * 2 ; 9 символов в строке занимает рамка,
                               ; всево в строке 80 символов, 80 - 9 = 71 осталось,
...
drow_all_frame PROC
    ...
    ; Далее нужно сделать столькоже вызовов функции dump_reg,
    ; сколько регистров добавлено в стек.
    ; Регистры будут выведены в последоваельности в которой они добавлены в стек.
    ; Перед каждым вызовом функции dump_reg,
    ; нужно в регистрок bx положить название соответствующего регистра,
